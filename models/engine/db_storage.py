...
if getenv('HBNB_TYPE_STORAGE') == 'db':
    ...
    class DBStorage:
        ...
        def __init__(self):
            """Instantiate the environment variables/db storage instances"""
        ...
        def new(self, obj):
            """
            function that adds obj to current database session
            """
            if obj is not None:
                try:
        ...
        def save(self):
            """
            commitin all changes made in the database session
            """
